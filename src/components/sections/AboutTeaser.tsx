    ...
    <Section background="light" padding="xl">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
        ...
        <div className="order-1 lg:order-2">
          <span className="inline-block px-3 py-1 rounded-full bg-earth/5 text-earth text-xs font-medium uppercase tracking-wider mb-4">
            Om oss
          </span>
          ...
          <div ref={sectionRef} className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-8">
            {values.map((value) => {
              ...
              return (
                ...
                >
                  <div className="w-10 h-10 rounded-xl bg-earth/5 flex items-center justify-center flex-shrink-0">
                    <IconComponent className="w-5 h-5 text-earth" />
                  </div>
                  <div>
          ...
          <Link
            href="/om-oss/"
            className={cn(
              'inline-flex items-center gap-2 text-earth font-medium',
